...
A simple re-usable component that allows you to add hidden actions behind items in a grid or list. The actions are configurable, as well as the icons representing them. You can try it by simply move items left/right with your mouse or touch : https://blog.obviousleap.co/demos/rater/
